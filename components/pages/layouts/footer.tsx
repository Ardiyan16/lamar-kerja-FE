...
const Footer = () => {
    ...
    return (
        <footer className="w-full mt-28 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                    <Link href="/">
                        <Image src={logo} className="drop-shadow-[0_0px_1px_rgba(255,255,255,.5)] object-scale-down min-w-12 min-h-12 rounded" height={40} width={175} alt="logo" />
                    </Link>
                    <p className="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">LamarKerja adalah platform iklan lowongan kerja yang dapat membantu pengguna menemukan lowongan kerja impian dan membantu perusahaan menemukan talenta terbaik di bidangnya ?</p>
                    <Link href="/"  className="py-2.5 px-5 h-9 block w-fit bg-primary rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-primary2 lg:mx-0">
                        Kunjungi Sekarang
                    </Link>
                </div>
            ...
            <div className="py-7 border-t border-gray-200">
                <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span className="text-sm text-gray-500 ">©<a href="/">LamarKerja.com</a> 2024, All rights reserved.</span>
